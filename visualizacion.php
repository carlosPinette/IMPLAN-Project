	...
	<html>
		<head>
			 		...
			 		<script src="/implan/js/jquery-ui.js"></script>
			  		<script src="/implan/js/accounting.min.js"></script>
		...
		<body>
			<header class="noprint">
				<div id="container1">
					...
					<a href="updateregistro.php" class="editar">Editar</a>
				...
				<a href="index.php" class="home"><img src ="img/home.png" height="48"></a>
					...
					******************************************************************-->
							...
							?>
										...
										<li><label>Anexo</label><a class="inputs" target="_blank" href="download.php?filename=<?php echo $row12[$i] ?>"><?php echo $row12[$i] ?></a></li>
										<?php } ?>
							</div>
						...
						<a href='impresion_visualizacion.php/?id=<?php echo $id ?>' target="_blank" ><input type="button" class="boton"value="Imprimir"></a>
						</ul>
